...
@section('title', 'Create User - Altamash Mobiles')

@section('content')
<div class="py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold">
            <i class="fas fa-plus-circle me-2 text-primary"></i> Create User
        </h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Upload profile image (JPG, PNG, GIF - Max 2MB)</small>
                            @error('avatar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
