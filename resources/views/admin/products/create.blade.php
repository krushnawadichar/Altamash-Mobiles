...
@section('title', 'Create Product - Altamash Mobiles')

@section('content')
<div class="py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold">
            <i class="fas fa-plus-circle me-2 text-primary"></i> Create Product
        </h2>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('mobile_company_id') is-invalid @enderror" 
                                ...
                                @foreach($mobileCompanies as $company)
                                    <option value="{{ $company->id }}" {{ old('mobile_company_id') == $company->id ? 'selected' : '' }}>
                                        {{ $company->name }}
                                    </option>
                                @endforeach
                            </select>
